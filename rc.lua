-- load custom settings for initializing below
...
-- create tags shared across monitors
...
awful.layout.layouts = asampley.layouts
-- }}}
	...
	s.mywibox:setup {
		...
		s.mytasklist,
		{
			...
			},
			{
				layout = awful.widget.only_on_screen,
				screen = 1,
				asampley.widgets.mem_graph,
			},
			asampley.widgets.volume,
			mytextclock,
			s.mylayoutbox,
		},
	}
